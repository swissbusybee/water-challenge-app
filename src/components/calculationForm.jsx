...
export default function CalculationForm() {
    ...
    const weeklyShower = showerDuration * 7;
    const weeklyBathroomFaucets = bathroomFaucetDuration * 7;
                ...
                <Box sx={{ m: 1 }}>
                    ...
                    >
                        <InputLabel id="shower-select-label">
                            How long is the average shower in your
                            household?
                        </InputLabel>
                        <Select
                        ...
                        >
                            ...
                            <MenuItem value={90}>5-10 Min</MenuItem>
                            <MenuItem value={135}>11-15 Min</MenuItem>
                            <MenuItem value={180}>
                                Over 15 Min
                            </MenuItem>
                        </Select>
                ...
                <Box sx={{ m: 1 }}>
                    ...
                    >
                        <InputLabel id="bathroom-faucet-select-label">
                            How long do the bathroom faucets run each
                            day?
                        </InputLabel>
                        <Select
                        ...
                        >
                            ...
                            <MenuItem value={60}>5-10 Min</MenuItem>
                            <MenuItem value={90}>11-15 Min</MenuItem>
                            <MenuItem value={120}>
                                Over 15 Min
                            </MenuItem>
                        </Select>
                ...
                <Box sx={{ m: 1 }}>
                    ...
                    >
                        <InputLabel id="kitchen-faucet-select-label">
                            How long do the kitchen faucets run each
                            day?
                        </InputLabel>
                        <Select
                        ...
                        >
                            ...
                            <MenuItem value={70}>5-10 Min</MenuItem>
                            <MenuItem value={140}>11-30 Min</MenuItem>
                            <MenuItem value={210}>
                                Over 30 Min
                            </MenuItem>
                        </Select>
                ...
                <Box sx={{ m: 1 }}>
                    ...
                    >
                        <InputLabel id="dishwasher-select-label">
                            How often to you use a dishwasher per
                            week?
                        </InputLabel>
                        <Select
                            ...
                            value={dishwasher}
                            label="Dishwasher"
                            onChange={handleChangeDishwasher}
                        >
                            {/* 20 liters per cycle */}
                            <MenuItem value={0}>
                ...
                <Box sx={{ m: 1 }}>
                    ...
                    >
                        <InputLabel id="washing-machine-select-label">
                            How often to you use a washing machine per
                            week?
                        </InputLabel>
                        <Select
                            ...
                            onChange={handleChangeWashingMachine}
                        >
                            {/* 50 liters per cycle */}
                            <MenuItem value={0}>
                                I don't use a washing machine
                            </MenuItem>
                            <MenuItem value={100}>
                                1 to 2 times per week
                            </MenuItem>
                ...
                <Box sx={{ m: 1 }}>
                    ...
                    >
                        <InputLabel id="bathtub-select-label">
                            How often to you take a bath per week?
                        </InputLabel>
                        <Select
            ...
            <Grid item xs={4}>
                <Grid container direction={'row'}>
                    <h4>
                        ...
                        washingMachine ||
                        bathtub
                            ? numberOfWaterLiters + ' Liters per week'
                            : ''}
                    </h4>
                ...
                <Grid container direction={'row'}>
                    {[...Array(numberOfWaterContainers)].map(
                        (e, i) => (
